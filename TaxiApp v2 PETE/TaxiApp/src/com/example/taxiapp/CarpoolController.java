...
public class CarpoolController extends ActionBarActivity {
    ...
    public void goToMakeOffer(View view) {
    	Intent intent = new Intent(this, MakeOfferTest.class);
	...
	private void intentpass(int positionlocal){//must be a private variable
		Intent intent = new Intent(this, DisplayMessageActivity.class);
		  String message = "Testing"+positionlocal;
